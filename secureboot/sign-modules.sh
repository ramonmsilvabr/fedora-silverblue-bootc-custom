...
if [ ! -f "$SIGN_FILE" ]; then
    ...
    echo "Certifique-se de que o pacote 'kernel-devel' está instalado (dnf -y install kernel-devel)."
    exit 1
fi
...
echo "Limpeza de chaves de criptografia por segurança"
